                ...
                <ul class="list-group list-group-flush">
                    <div class="list-group-item">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="date" class="form-control" id="ngayThi" placeholder="Nhập ngày thi (dd/mm/yyyy)" name="ngaythi" value="2024-03-25" />
                        </div>
                        <!--Ngày kí xác nhận-->
                        <div class="input-group mb-3">
                            <span class="input-group-text">Ngày kí xác nhận</span>
                            <input type="date" class="form-control" id="ngayKiXacNhan" placeholder="Nhập ngày kí xác nhận (dd/mm/yyyy)" name="kixacnhan" value="2024-03-25"/>
                        </div>
                        <!--Số lượng câu hỏi-->
                        <div class="input-group mb-3">
